...
% @Last modified time: 2019-07-10 23:40:38
...
\begin{textblock}{20.5}(0.25, 3.5)
  ...
  \begin{minipage}[t]{0.37\textwidth}
    ...
    \sectionleft{Key skills}
      ...
      \subsectionleft{Languages:}{French (\textbf{native speaker}), English (\textbf{professional skill}, language of instruction of Master's Degree).}
    ...
    \sectionleft{Programming}
      ...
      \subsectionleft{Advanced:}{\textbf{Shell}, VBA, LaTeX.} %Matlab/Octave,
  ...
  \end{minipage}\hfill\begin{minipage}[t]{0.61\textwidth}
    ...
    \section{Experiences}
      \begin{rightenv}
        ...
        \subsectionright{Jun. 2018 – Dec. 2018}{Intern in Quantitative Finance}[Napoleon Crypto][Paris]{Research of quantitative strategies and \textbf{portfolio allocation} algorithms. \textbf{Data-science competition} elaborated for the Collège de France.}
