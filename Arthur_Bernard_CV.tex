...
% @Last modified time: 2019-07-09 23:47:55
...
\begin{textblock}{20.5}(0.25, 3.5)
  ...
  \begin{minipage}[t]{0.37\textwidth}
    ...
    \sectionleft{Key skills}
      \subsectionleft{Proficiency in \textbf{statistics} and \textbf{econometrics softwares}:}{Octave/Matlab (Advanced), R (Advanced), SAS (Beginner), STATA (Beginner).}
      \subsectionleft{Operating systems:}{Windows and \textbf{Unix}.}
      \subsectionleft{Languages:}{French (\textbf{native speaker}), English (\textbf{professional skill}, langage of instruction of Master's Degree).}

    \sectionleft{Programming}
      \subsectionleft{Highly advanced:}{\textbf{Python} (proficiency in NumPy, Pandas, Cython, PyTorch, Keras, Sickit-Learn, Asyncio, Multi-process/thread), etc.}
      \subsectionleft{Advanced:}{\textbf{Shell}, VBA, Matlab/Octave, LaTeX.}
