...
% @Last modified time: 2019-08-03 18:16:47
...
\begin{textblock}{20.5}(0.25, 3.5)
  ...
  \end{minipage}\hfill\begin{minipage}[t]{0.61\textwidth}
    ...
    \section{Projets personnels}
      \begin{rightenv}
        \subsectionright{2018 – 2019}{Outils de machine/deep learning adapté à la finance}{Développement d'un package en python et cython pour créer des \textbf{réseaux de neuronnes}, \textbf{backtester des stratégies}, analyser des \textbf{models éconmetric} et faire \textbf{indicateurs financiers}, etc. Publié sur PyPI sous le nom \href{https://github.com/ArthurBernard/Fynance}{\color{colhyperlink}{\textit{fynance}}}.}
