...
% @Last modified time: 2019-07-23 08:59:33
...
\begin{textblock}{20.5}(0.25, 3.5)
  ...
  \end{minipage}\hfill\begin{minipage}[t]{0.61\textwidth}
    ...
    \section{Projets personnels}
      \begin{rightenv}
        \subsectionright{2018 – 2019}{Outils de machine/deep learning adapté à la finance}{Développement d'un package en python et cython pour créer des \textbf{réseaux de neuronnes}, \textbf{backtester des stratégies}, analyser des \textbf{models éconmetric} et faire \textbf{indicateurs financiers}, etc. Publié sur PyPI sous le nom \href{https://github.com/ArthurBernard/Fynance}{\textit{fynance}}.}
        \subsectionright{2017 – 2018}{Package de webscraping}{Développement d'un package python pour \textbf{télécharger} et \textbf{mettre à jour une base de données} sur les crypto-monnaies. Publié sur PyPI sous le nom \href{https://github.com/ArthurBernard/Download_Crypto_Currencies_Data}{\textit{dccd}}.}
        \subsectionright{2016 – 2019}{Algorithmes de trading sur les crypto-monnaies}{Développement et maintenance de bots de trading avec des scripts en python et bash. Commencé en 2016 avec des \textbf{stratégies d'arbitrages}, et plus récemment creation de \textbf{stratégies avec des réseaux de neuronnes}. Une partie des scripts est disponnible sur mon GitHub dans le répertoire \href{https://github.com/ArthurBernard/Strategy_Manager}{\textit{Strategy\_Manager}}.}
      \end{rightenv}
